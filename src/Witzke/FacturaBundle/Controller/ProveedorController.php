...
use Witzke\FacturaBundle\Entity\Proveedor;
use Witzke\FacturaBundle\Form\ProveedorType;
...
class ProveedorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FacturaBundle:Proveedor')->findAll();

        return $this->render('FacturaBundle:Proveedor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FacturaBundle:Proveedor:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FacturaBundle:Proveedor')->find($id);
        ...
        return $this->render('FacturaBundle:Proveedor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FacturaBundle:Proveedor:edit.html.twig', array(
            'entity'      => $entity,
